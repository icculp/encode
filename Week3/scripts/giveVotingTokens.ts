...
async function main() {
    ...
    console.log(`Before the mint, Ian has ${ianTokenBalance} decimals of balance`)
    let ianTVotePower = await contract.getVotes(JACOB_ADDRESS)
    ...
    console.log(`Before the mint, Jacob has ${jacobTokenBalance} decimals of balance`)
    ...
    console.log(`Before the mint, Jeremy has ${jeremyTokenBalance} decimals of balance`)
    let jeremyVotePower = await contract.getVotes(JEREMYS_ADDRESS)
    console.log(`Before the mint, Jeremy has ${jeremyVotePower} decimals of power`)
    ...
    console.log(`After the mint, Jacob has ${ianTokenBalance} decimals of balance`)
    ...
    console.log(`After the mint, Jeremy has ${ianTokenBalance} decimals of balance`)
